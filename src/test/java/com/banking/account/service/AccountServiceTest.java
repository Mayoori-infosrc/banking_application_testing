...
class AccountServiceTest {
    ...
    void getAccount_WithInvalidId_ShouldThrowException() {
        assertThrows(InvalidAccountException.class, () -> accountService.getAccount("invalid-id"));
    }
    ...
    void getAllAccounts_ShouldReturnAllAccounts() {
        accountService.createAccount(CUSTOMER_ID, ACCOUNT_TYPE, INITIAL_BALANCE);
        accountService.createAccount("67890", AccountType.CHECKING, INITIAL_BALANCE);
