...
class AccountTest {
    ...
    void testConstructorWithInvalidCustomerId(String invalidCustomerId) {
        assertThrows(IllegalArgumentException.class, () -> new Account(invalidCustomerId, VALID_ACCOUNT_TYPE, VALID_INITIAL_BALANCE));
    }

    @Test
    void testConstructorWithNullAccountType() {
        assertThrows(IllegalArgumentException.class, () -> new Account(VALID_CUSTOMER_ID, null, VALID_INITIAL_BALANCE));
    }

    @Test
    void testConstructorWithNullInitialBalance() {
        assertThrows(IllegalArgumentException.class, () -> new Account(VALID_CUSTOMER_ID, VALID_ACCOUNT_TYPE, null));
    }
    ...
    void testDepositWithNegativeAmount() {
        assertThrows(IllegalArgumentException.class, () -> account.deposit(new Money(BigDecimal.valueOf(-50), "USD")));
    }
    ...
    void testWithdrawWithInsufficientFunds() {
        Money withdrawAmount = new Money(BigDecimal.valueOf(150), "USD");
    ...
    void testWithdrawWithNegativeAmount() {
        assertThrows(IllegalArgumentException.class, () -> account.withdraw(new Money(BigDecimal.valueOf(-50), "USD")));
    }
    ...
    void testDepositOnInactiveAccount() {
        account.deactivate();
        assertThrows(InvalidAccountException.class, () -> account.deposit(new Money(BigDecimal.valueOf(50), "USD")));
    }

    @Test
    void testWithdrawOnInactiveAccount() {
        account.deactivate();
        assertThrows(InvalidAccountException.class, () -> account.withdraw(new Money(BigDecimal.valueOf(50), "USD")));
    }
